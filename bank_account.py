class AccountDB:
    ...
    def insert(self, account):
        ...
        if index == -1:
            ...
            return print("Duplicated account")
    ...
    def delete_account(self, account):
        ...
        if index != -1:
            ...
            print("invalid account number; nothing to be deleted.")
    ...
    def __str__(self):
        return ''.join(f"{item}, " for item in self.account_database)
...
print(my_account_DB)
my_account_DB.delete_account(account1)
print('after deleted')
print(my_account_DB)